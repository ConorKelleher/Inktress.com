...
import ArcLabsThumb from "src/assets/images/portfolio/design/Arc Labs S.jpg"
import BillBarberFull from "src/assets/images/portfolio/design/Bill Barber L.jpg"
import BillBarberThumb from "src/assets/images/portfolio/design/Bill Barber S.jpg"
import BirdBooksFull from "src/assets/images/portfolio/design/Bird Books L.jpg"
import BirdBooksThumb from "src/assets/images/portfolio/design/Bird Books S.jpg"
import BirdBooksSocialsFull from "src/assets/images/portfolio/design/Bird Books Socials L.jpg"
import BirdBooksSocialsThumb from "src/assets/images/portfolio/design/Bird Books Socials S.jpg"
import BusinessCardTemplatesFull from "src/assets/images/portfolio/design/Business Card Templates L.jpg"
import BusinessCardTemplatesThumb from "src/assets/images/portfolio/design/Business Card Templates S.jpg"
import CandidFull from "src/assets/images/portfolio/design/Candid L.jpg"
import CandidThumb from "src/assets/images/portfolio/design/Candid S.jpg"
import ClarksBlackFridayFull from "src/assets/images/portfolio/design/Clarks Black Friday L.jpg"
...
import GoodVibesThumb from "src/assets/images/portfolio/design/Good Vibes S.jpg"
import GraveGirlsFull from "src/assets/images/portfolio/design/Grave Girls L.jpg"
import GraveGirlsThumb from "src/assets/images/portfolio/design/Grave Girls S.jpg"
import GraveGirlsSocialsFull from "src/assets/images/portfolio/design/Grave Girls Socials L.jpg"
...
import PlantSaleThumb from "src/assets/images/portfolio/design/Plant Sale S.jpg"
import PottersFull from "src/assets/images/portfolio/design/Potters L.jpg"
import PottersThumb from "src/assets/images/portfolio/design/Potters S.jpg"
import PridePrejudiceFull from "src/assets/images/portfolio/design/Pride & Prejudice L.jpg"
import PridePrejudiceThumb from "src/assets/images/portfolio/design/Pride & Prejudice S.jpg"
import RemedeaseAdFull from "src/assets/images/portfolio/design/Remedease Ad L.jpg"
...
import TastyBakeryPhoneThumb from "src/assets/images/portfolio/design/Tasty Bakery Phone S.jpg"
import ThankYouCardFull from "src/assets/images/portfolio/design/Thank You Card L.jpg"
import ThankYouCardThumb from "src/assets/images/portfolio/design/Thank You Card S.jpg"
import TheEndFull from "src/assets/images/portfolio/design/The End L.jpg"
import TheEndThumb from "src/assets/images/portfolio/design/The End S.jpg"
import TheHitchhikersGuideToTheGalaxyFull from "src/assets/images/portfolio/design/The Hitchhikers Guide to the Galaxy L.jpg"
import TheHitchhikersGuideToTheGalaxyThumb from "src/assets/images/portfolio/design/The Hitchhikers Guide to the Galaxy S.jpg"
import ThriftGiftFull from "src/assets/images/portfolio/design/Thrift & Gift L.jpg"
...
import CastleThumb from "src/assets/images/portfolio/illustration/Castle S.jpg"
import CatFull from "src/assets/images/portfolio/illustration/Cat L.jpg"
import CatThumb from "src/assets/images/portfolio/illustration/Cat S.jpg"
import ClaraFull from "src/assets/images/portfolio/illustration/Clara L.jpg"
import ClaraThumb from "src/assets/images/portfolio/illustration/Clara S.jpg"
import CliveFull from "src/assets/images/portfolio/illustration/Clive L.jpg"
...
import FroggingThumb from "src/assets/images/portfolio/illustration/Frogging S.jpg"
import FutureHomesFull from "src/assets/images/portfolio/illustration/Future Homes L.jpg"
import FutureHomesThumb from "src/assets/images/portfolio/illustration/Future Homes S.jpg"
import GetSnuffedFull from "src/assets/images/portfolio/illustration/Get Snuffed L.jpg"
...
import MaggieThumb from "src/assets/images/portfolio/illustration/Maggie S.jpg"
import MarsFull from "src/assets/images/portfolio/illustration/Mars L.jpg"
import MarsThumb from "src/assets/images/portfolio/illustration/Mars S.jpg"
import MushmanFull from "src/assets/images/portfolio/illustration/Mushman L.jpg"
...
export const PortfolioItemKeys = {
  ...
  "Cat": "Cat",
  "Clara": "Clara",
  "ClarksBlackFriday": "ClarksBlackFriday",
  "ClarksCampaign": "ClarksCampaign",
  "Clive": "Clive",
  "CloseUp": "CloseUp",
  ...
  "GoOutdoorsDigitalCircular": "GoOutdoorsDigitalCircular",
...
const PortfolioItems: Record<keyof typeof PortfolioItemKeys, PortfolioItem> = {
  ...
  "AFieryFamiliar": {
    ...
    "imageURL": AFieryFamiliarFull,
    "thumbnailURL": AFieryFamiliarThumb,
  ...
  "AmandaWebsterTherapies": {
    ...
    "imageURL": AmandaWebsterTherapiesFull,
    "thumbnailURL": AmandaWebsterTherapiesThumb,
  ...
  "ArcLabs": {
    ...
    "imageURL": ArcLabsFull,
    "thumbnailURL": ArcLabsThumb,
    "name": "Arc Labs",
    "height": 932,
    "width": 1101
  },
  "AutumnLonging": {
    ...
    "imageURL": AutumnLongingFull,
    "thumbnailURL": AutumnLongingThumb,
    "name": "Autumn Longing",
    "height": 2879,
    "width": 2000
  },
  "BillBarber": {
    ...
    "imageURL": BillBarberFull,
    "thumbnailURL": BillBarberThumb,
    "name": "Bill Barber",
    "height": 1080,
    "width": 1095
  },
  "BirdBooks": {
    ...
    "imageURL": BirdBooksFull,
    "thumbnailURL": BirdBooksThumb,
    "name": "Bird Books",
    "height": 1119,
    "width": 792
  },
  "BirdBooksSocials": {
    ...
    "imageURL": BirdBooksSocialsFull,
    "thumbnailURL": BirdBooksSocialsThumb,
  ...
  "BusinessCardTemplates": {
    ...
    "imageURL": BusinessCardTemplatesFull,
    "thumbnailURL": BusinessCardTemplatesThumb,
  ...
  "ClarksBlackFriday": {
    "page": "design",
    "blurHash": "|PQvL0xD_M?bV=-:Mx%1RPrqaytRoft7ofRjbHWA%LtRRPRPWZafj]fkt8Dhof-;V@ozozRifkae4TRP%htRxvogWra}V@?cWBV?tRRPWAt8f6j]o}ofV@WBfSaebJbIogxaozocRikDfQayoffl%Nj[Rjayozofj[f6j]",
    "imageURL": ClarksBlackFridayFull,
    "thumbnailURL": ClarksBlackFridayThumb,
    "name": "Clarks Black Friday",
    "height": 1080,
    "width": 1080
  },
  "ClarksCampaign": {
    "page": "design",
    "blurHash": "|CG8o]}[9G9tu3_MEKV@MxMz?H%2Io%g%fxuo0ni9tNZ%Mn%-pn,s:xuWV_1E1IpjIxbr]Mxj@ba00bbs.xaD%D*t7NFt6.8IUf6%2D%IUWCWWR*00R*WqM{ofn%oMj]xukW%MRjjYRjj[t7a}t6%3IVWB%MWAWVRjfkRk",
    "imageURL": ClarksCampaignFull,
    "thumbnailURL": ClarksCampaignThumb,
    "name": "Clarks Campaign",
    "height": 1080,
    "width": 1080
  },
  "Clive": {
  ...
  "CloseUp": {
    ...
    "imageURL": CloseUpFull,
    "thumbnailURL": CloseUpThumb,
    "name": "Close Up",
    "height": 2048,
    "width": 2048
  },
  ...
  "CrocsComeAsYouAre": {
    ...
    "imageURL": CrocsComeAsYouAreFull,
    "thumbnailURL": CrocsComeAsYouAreThumb,
    "name": "Crocs Come As You Are",
    "height": 1080,
    "width": 1080
  },
  "CrocsHolidayRush": {
    "page": "design",
    "blurHash": "|iOf.8t7?H%Li^xuVrxaMx%$fkxZofaej@oej[Rj=@jsIUaxM{WBofWBof~qj[M{ayRjofWBofofDiays,WAxuj@ofofj[IAoft7WBt7WBj@ofofxuofoej@RjWAWBfPofngayjYj@WBaxa#fPf7RiWBtRofaeoff6aya}",
    "imageURL": CrocsHolidayRushFull,
    "thumbnailURL": CrocsHolidayRushThumb,
    "name": "Crocs Holiday Rush",
    "height": 1080,
    "width": 1080
  },
  "Croctober": {
    "page": "design",
    "blurHash": "|vQ9Z#$+o}xuW=xuX8xuRl_LR*WooeWBjsbGj[ayJ7spjFWBV@afoLayfiyCf+jbfkWBaze:j[ayIBafoyj@ofayj@j@j[RSjbkCkCj[bHkBa}j[yCWCV[j@aekBayf6afbbo2kBWBf7kCkBj[ayNGf8ayfQofafj[fjkB",
    "imageURL": CroctoberFull,
    "thumbnailURL": CroctoberThumb,
    "name": "Croctober",
    "height": 1080,
    "width": 1080
  },
  ...
  "DetectivesAbode": {
    ...
    "imageURL": DetectivesAbodeFull,
    "thumbnailURL": DetectivesAbodeThumb,
  ...
  "DoughnutMoon": {
    ...
    "imageURL": DoughnutMoonFull,
    "thumbnailURL": DoughnutMoonThumb,
    "name": "Doughnut Moon",
    "height": 1618,
    "width": 2000
  },
  ...
  "EnglishBusStop": {
    ...
    "imageURL": EnglishBusStopFull,
    "thumbnailURL": EnglishBusStopThumb,
  ...
  "FishiesComeToTown": {
    ...
    "imageURL": FishiesComeToTownFull,
    "thumbnailURL": FishiesComeToTownThumb,
  ...
  "FlightOfTheNightLights": {
    ...
    "imageURL": FlightOfTheNightLightsFull,
    "thumbnailURL": FlightOfTheNightLightsThumb,
  ...
  "Frogging": {
    ...
    "imageURL": FroggingFull,
    "thumbnailURL": FroggingThumb,
    "name": "Frogging",
    "height": 1200,
    "width": 1200
  },
  "FutureHomes": {
    ...
    "imageURL": FutureHomesFull,
    "thumbnailURL": FutureHomesThumb,
    "name": "Future Homes",
    "height": 2000,
    "width": 2000
  },
  "GetSnuffed": {
    ...
    "imageURL": GetSnuffedFull,
    "thumbnailURL": GetSnuffedThumb,
    "name": "Get Snuffed",
    "height": 2879,
    "width": 2000
  },
  "GoOutdoorsDigitalCircular": {
    "page": "design",
    "blurHash": "|lO:d{oftUxagPxt-;o#-;xtj?j]oea#WEWWj@oeX=a#ngj]sjoejXoJR+o#WWf6a}ocs-odazfkWBoextoKa~R-WCoeaeRka#xaaya~odj[a#oeaJj[o#ayofj[ayj[WB-moeR.f6oeWDfRoLWVRia#t7WVofs.a{a#WB",
    "imageURL": GoOutdoorsDigitalCircularFull,
    "thumbnailURL": GoOutdoorsDigitalCircularThumb,
    "name": "Go Outdoors Digital Circular",
    "height": 938,
    "width": 502
  },
  "GoldenCity": {
    ...
    "imageURL": GoldenCityFull,
    "thumbnailURL": GoldenCityThumb,
    "name": "Golden City",
    "height": 1587,
    "width": 2000
  },
  "GoodVibes": {
    ...
    "imageURL": GoodVibesFull,
    "thumbnailURL": GoodVibesThumb,
    "name": "Good Vibes",
    "height": 1080,
    "width": 1203
  },
  "GraveGirls": {
    ...
    "imageURL": GraveGirlsFull,
    "thumbnailURL": GraveGirlsThumb,
    "name": "Grave Girls",
    "height": 1374,
    "width": 1168
  },
  "GraveGirlsSocials": {
    ...
    "imageURL": GraveGirlsSocialsFull,
    "thumbnailURL": GraveGirlsSocialsThumb,
  ...
  "InkantressSocials": {
    ...
    "imageURL": InkantressSocialsFull,
    "thumbnailURL": InkantressSocialsThumb,
  ...
  "JDBlackFriday": {
    "page": "design",
    "blurHash": "|TKK$aW9%J4n4n~qf6?cIp?bITD%RijYt9RjRkozRiogIUxut7Rjj]IUt8t8Rlogt8ofxtofoyofIU%2t7WrogIUWAkCf5ITa$s.R*a#n$ogofV@IoWAoMofj[ofofofWBxaxvofofWCRij[WBkCROM{RjogogofaeWAof",
    "imageURL": JDBlackFridayFull,
    "thumbnailURL": JDBlackFridayThumb,
    "name": "JD Black Friday",
    "height": 1080,
    "width": 1080
  },
  "JohnLewisUniversity": {
    "page": "design",
    "blurHash": "|AHKh8~Woe%Lof%2of%1s:IAMxn~WBaeaxayjZaes.ofNdWWjtayjtayaz=^oJR-a|a}fRa}fkfksmoLj?ayWXf7WVWWoKt7j[snj@bHj[azfRj@R,WVjsj[oJf6oJj?ayxuj[WVj[oJjuoKoJayR+ayo0ayfPfPfijsf6",
    "imageURL": JohnLewisUniversityFull,
    "thumbnailURL": JohnLewisUniversityThumb,
    "name": "John Lewis University",
    "height": 1080,
    "width": 1080
  },
  "Lemons": {
  ...
  "LetsPlay": {
    ...
    "imageURL": LetsPlayFull,
    "thumbnailURL": LetsPlayThumb,
    "name": "Let's Play",
    "height": 1411,
    "width": 1398
  },
  ...
  "LocalBoast": {
    ...
    "imageURL": LocalBoastFull,
    "thumbnailURL": LocalBoastThumb,
    "name": "Local Boast",
    "height": 807,
    "width": 1575
  },
  ...
  "MonsterousRegiment": {
    ...
    "imageURL": MonsterousRegimentFull,
    "thumbnailURL": MonsterousRegimentThumb,
  ...
  "Mushman": {
    ...
    "imageURL": MushmanFull,
    "thumbnailURL": MushmanThumb,
    "name": "Mushman",
    "height": 2879,
    "width": 2000
  },
  "NightSky": {
    ...
    "imageURL": NightSkyFull,
    "thumbnailURL": NightSkyThumb,
    "name": "Night Sky",
    "height": 1090,
    "width": 1090
  },
  ...
  "PapierCampaign": {
    "page": "design",
    "blurHash": "|HMZ]stT9b-:IVxsW=%LRk00$~IpM|tRjYofWVt701xr%0ITjrNHoINGWAxue??a%Ks:WEoet7ay~Vo0MxkYt7xYNGafoL?b-oWER.IVxuxut7WVMwt7IqV?M|IoM|oet6-;%2xuR+xYt7WBM|WB0Lxtxuf5t7t7xtj]Rj",
    "imageURL": PapierCampaignFull,
    "thumbnailURL": PapierCampaignThumb,
    "name": "Papier Campaign",
    "height": 1280,
    "width": 720
  },
  "PlantSale": {
    ...
    "imageURL": PlantSaleFull,
    "thumbnailURL": PlantSaleThumb,
    "name": "Plant Sale",
    "height": 1414,
    "width": 1000
  },
  "Potters": {
    ...
    "imageURL": PottersFull,
    "thumbnailURL": PottersThumb,
    "name": "Potters",
    "height": 1393,
    "width": 1000
  },
  "Pride&Prejudice": {
    ...
    "imageURL": PridePrejudiceFull,
    "thumbnailURL": PridePrejudiceThumb,
  ...
  "Recycle": {
    ...
    "imageURL": RecycleFull,
    "thumbnailURL": RecycleThumb,
    "name": "Recycle",
    "height": 1083,
    "width": 900
  },
  "Remedease": {
    ...
    "imageURL": RemedeaseFull,
    "thumbnailURL": RemedeaseThumb,
    "name": "Remedease",
    "height": 1128,
    "width": 1109
  },
  "RemedeaseAd": {
    ...
    "imageURL": RemedeaseAdFull,
    "thumbnailURL": RemedeaseAdThumb,
    "name": "Remedease Ad",
    "height": 1080,
    "width": 1080
  },
  ...
  "RoastersFestSocials": {
    ...
    "imageURL": RoastersFestSocialsFull,
    "thumbnailURL": RoastersFestSocialsThumb,
  ...
  "Rose&Crown": {
    ...
    "imageURL": RoseCrownFull,
    "thumbnailURL": RoseCrownThumb,
    "name": "Rose & Crown",
    "height": 1083,
    "width": 1080
  },
  ...
  "SimonJax": {
    ...
    "imageURL": SimonJaxFull,
    "thumbnailURL": SimonJaxThumb,
    "name": "Simon Jax",
    "height": 1200,
    "width": 1200
  },
  "SizeTiktok": {
    "page": "design",
    "blurHash": "|aKQpZwdWCsTf6soaysoja}DjZjZj[aeoKj[oKfk9]bHfkbHkCa|a|ayjtjFayofaykCayfkj[aeAtazWCayfQazf6a|j[OroLWBj[aefkjtayj[F0WCoLWqjZbHa|jta|I:aykCa|j[a|aya|ayI;fkbHf6bHayj[bHf6",
    "imageURL": SizeTiktokFull,
    "thumbnailURL": SizeTiktokThumb,
    "name": "Size Tiktok",
    "height": 2338,
    "width": 1080
  },
  "SlitherinAndShiverin": {
    ...
    "imageURL": SlitherinAndShiverinFull,
    "thumbnailURL": SlitherinAndShiverinThumb,
  ...
  "SubmAIRine": {
    ...
    "imageURL": SubmAIRineFull,
    "thumbnailURL": SubmAIRineThumb,
    "name": "SubmAIRine",
    "height": 1259,
    "width": 1000
  },
  ...
  "TastyBakeryDesktop": {
    ...
    "imageURL": TastyBakeryDesktopFull,
    "thumbnailURL": TastyBakeryDesktopThumb,
  ...
  "TastyBakeryPhone": {
    ...
    "imageURL": TastyBakeryPhoneFull,
    "thumbnailURL": TastyBakeryPhoneThumb,
  ...
  "ThankYouCard": {
    ...
    "imageURL": ThankYouCardFull,
    "thumbnailURL": ThankYouCardThumb,
    "name": "Thank You Card",
    "height": 1195,
    "width": 871
  },
  ...
  "TheHitchhikersGuideToTheGalaxy": {
    ...
    "imageURL": TheHitchhikersGuideToTheGalaxyFull,
    "thumbnailURL": TheHitchhikersGuideToTheGalaxyThumb,
  ...
  "TheMill": {
    ...
    "imageURL": TheMillFull,
    "thumbnailURL": TheMillThumb,
    "name": "The Mill",
    "height": 1411,
    "width": 1000
  },
  "Thrift&Gift": {
    ...
    "imageURL": ThriftGiftFull,
    "thumbnailURL": ThriftGiftThumb,
    "name": "Thrift & Gift",
    "height": 2829,
    "width": 2000
  },
  "Thrift&GiftSocials": {
    ...
    "imageURL": ThriftGiftSocialsFull,
    "thumbnailURL": ThriftGiftSocialsThumb,
  ...
  "TurnMeOn": {
    ...
    "imageURL": TurnMeOnFull,
    "thumbnailURL": TurnMeOnThumb,
    "name": "Turn Me On",
    "height": 1594,
    "width": 2000
  },
  ...
  "WayStation": {
    ...
    "imageURL": WayStationFull,
    "thumbnailURL": WayStationThumb,
    "name": "Way Station",
    "height": 1000,
    "width": 1000
  },
  "WesternAirTemple": {
    ...
    "imageURL": WesternAirTempleFull,
    "thumbnailURL": WesternAirTempleThumb,
  ...
  "WhiteCliffsOfVictoria": {
    ...
    "imageURL": WhiteCliffsOfVictoriaFull,
    "thumbnailURL": WhiteCliffsOfVictoriaThumb,
  ...
  "WiseOldWorm": {
    ...
    "imageURL": WiseOldWormFull,
    "thumbnailURL": WiseOldWormThumb,
    "name": "Wise Old Worm",
    "height": 1200,
    "width": 1201
  },
